...
@router.post("/", response_model=schemas.Order, dependencies=[Depends(dependencies.role_required("admin"))])
...
@router.put("/{order_id}", response_model=schemas.Order, dependencies=[Depends(dependencies.role_required("admin"))])
...
@router.delete("/{order_id}", dependencies=[Depends(dependencies.role_required("admin"))])
